...
const SettingsTab = ({ settings, onUpdate, onCreate, onDelete, onTriggerDrill }) => {
  ...
  // Sync local state when parent settings prop changes (e.g., after fetch)
  useEffect(() => {
  ...
  return (
    <div style={{ backgroundColor: 'white', padding: '25px', borderRadius: '15px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)', maxWidth: '600px' }}>
      ...
      <h3 style={{ color: '#1a237e', marginTop: '40px', marginBottom: '20px' }}>💬 WhatsApp Message Templates (Quick Reply සැකිලි)</h3>
