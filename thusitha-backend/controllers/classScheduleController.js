...
exports.createClassSchedule = async (req, res) => {
  ...
  try {
    ...
    const query = `
      INSERT INTO Class_Schedules (course_id, hall_id, day_of_week, start_time, end_time, class_name, capacity)
      VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *
    `;
    const result = await client.query(query, [course_id, hall_id, day_of_week, start_time, end_time, class_name, capacity]);

    // Link course to teacher and subject
    await client.query(
...
exports.updateClassSchedule = async (req, res) => {
  ...
  try {
    ...
    const query = `
      ...
      SET course_id = $1, hall_id = $2, day_of_week = $3, start_time = $4, end_time = $5, class_name = $6, capacity = $7
      WHERE schedule_id = $8 RETURNING *
    `;
    const result = await client.query(query, [course_id, hall_id, day_of_week, start_time, end_time, class_name, capacity, id]);
